...
sudo pacman -S htop bc vim vi lolcat grep fzf cmus nnn gimp dmenu zathura npm rust github-cli less neofetch tree lua obs-studio mpv man wpa_supplicant-openrc dhcpcd-openrc networkmanager-openrc man wget ripgrep usbutils alsa-utils alsa-firmware
